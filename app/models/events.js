const Model 	    = require(__path_schemas + 'events');
...
module.exports = {
    listItems: (params, options = null) => {
        ...
        return Model
		.find(objWhere)
		.select('name status ordering created modified thumb slug expiration_date type')
		.sort(sort)
    ...
    listItemsFrontend: (params = null, option = null) => {
        ...
        let select = 'name thumb expiration_date type slug';
        let limit = 1;
